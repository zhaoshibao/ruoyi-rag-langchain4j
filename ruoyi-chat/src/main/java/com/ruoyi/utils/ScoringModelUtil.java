 ...
 */
@Slf4j
public class RerankeModelUtil {
    private static ScoringModel rerankeModel;

    // 私有构造方法，防止实例化
    private RerankeModelUtil() {
    ...
    private static Path convertClasspathToPath(String classpath) throws Exception {
        ...
        // 获取类加载器并读取资源 URL
        ClassLoader classLoader = RerankeModelUtil.class.getClassLoader();
